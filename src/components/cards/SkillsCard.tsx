...
export default function SkillsCard() {
  return (
    ...
    >
      <p className="text-[9px] tracking-[2.5px] uppercase text-neutral-400 mb-3">Core Skills</p>
      ...
      <div className="border-t border-white/5 pt-3">
        <p className="text-[9px] tracking-[2px] uppercase text-neutral-700 mb-2">AI & Agentic</p>
        <div className="flex flex-wrap gap-1.5">
          {aiSkills.map((skill) => (
            <span
              key={skill.label}
