...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Open-source intelligence toolkit for geopolitical monitoring and risk factoring around the world. Passive reconnaissance and information gathering across global sources.",
    detail: "Collection of OSINT tooling built for geopolitical monitoring, risk factoring, and passive intelligence gathering across global open sources. Developed alongside the UoW CS cybersecurity major and extended with personal research into threat intelligence and geopolitical signal tracking.",
    tech: ["Python", "OSINT frameworks", "Reconnaissance", "Data aggregation"],
    outcomes: [
      "Purpose-built for geopolitical monitoring and global risk factoring",
      "Passive reconnaissance and open-source intelligence gathering across international sources",
      "Developed alongside UoW Bachelor of CS (Cybersecurity major) and extended with personal research",
    ],
